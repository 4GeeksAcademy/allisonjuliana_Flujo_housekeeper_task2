...
Revision ID: 168e757265b9
Revises: 
Create Date: 2025-03-14 21:54:28.720977
...
def upgrade():
    ...
    op.create_table('incidentmaintenancetask',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('nombre', sa.String(length=120), nullable=False),
...
def downgrade():
    ...
    op.drop_table('incidentmaintenancetask')
